$(document).ready(function() {
    ...
    var $meetStates = $("#meetStates");

    var $searchButton = $("#searchButton");
    var $grid = $("#allDistributeList");
    var gridPager = "#allDistributeListPager";

    var gridUrl = function() {
        var listUrl =
            "../MeetQuery/GetMyAllDistributeList?keywords={keywords}&state={state}&activateIsoDate={activateIsoDate}";
        listUrl = listUrl.replace("{keywords}", $searchText.val());
        listUrl = listUrl.replace("{state}", $meetStates.val());
