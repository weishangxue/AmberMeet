$(document).ready(function() {
    ...
    var $grid = $("#alreadySignedList");
    var gridPager = "#alreadySignedListPager";

    var gridUrl = function() {
        var listUrl = "../MeetSignfor/GetAlreadySignedList?keywords={keywords}&activateIsoDate={activateIsoDate}";
